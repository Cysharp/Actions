...
internal record GitHubEnv
{
    ...
    /// Always set to true.
    /// </summary>
    public bool CI { get; init; } = bool.Parse(Environment.GetEnvironmentVariable(nameof(CI)) ?? "false");
    /// <summary>
    ...
    /// </summary>
    public string GITHUB_ACTION { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_ACTION)) ?? "";
    /// <summary>
    ...
    /// </summary>
    public string GITHUB_ACTION_PATH { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_ACTION_PATH)) ?? "";
    /// <summary>
    /// For a step executing an action, this is the owner and repository name of the action. For example, actions/checkout.
    /// </summary>
    public string GITHUB_ACTION_REPOSITORY { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_ACTION_REPOSITORY)) ?? "";
    /// <summary>
    /// Always set to true when GitHub Actions is running the workflow. You can use this variable to differentiate when tests are being run locally or by GitHub Actions.
    /// </summary>
    public bool GITHUB_ACTIONS { get; init; } = bool.Parse(Environment.GetEnvironmentVariable(nameof(GITHUB_ACTIONS)) ?? "false");
    /// <summary>
    /// The name of the person or app that initiated the workflow. For example, octocat.
    /// </summary>
    public string GITHUB_ACTOR { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_ACTOR)) ?? "";
    /// <summary>
    ...
    /// </summary>
    public string GITHUB_BASE_REF { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_BASE_REF)) ?? "";
    /// <summary>
    ...
    /// </summary>
    public string GITHUB_ENV { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_ENV)) ?? "";
    /// <summary>
    /// The name of the event that triggered the workflow. For example, workflow_dispatch.
    /// </summary>
    public string GITHUB_EVENT_NAME { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_EVENT_NAME)) ?? throw new ArgumentNullException("Environment Variable 'GITHUB_EVENT_NAME' is missing.");
    /// <summary>
    /// The path to the file on the runner that contains the full event webhook payload. For example, /github/workflow/event.json.
    /// </summary>
    public string GITHUB_EVENT_PATH { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_EVENT_PATH)) ?? "";
    /// <summary>
    ...
    /// </summary>
    public string GITHUB_HEAD_REF { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_HEAD_REF)) ?? "";
    /// <summary>
    /// The job_id of the current job. For example, greeting_job.
    /// </summary>
    public string GITHUB_JOB { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_JOB)) ?? "";
    /// <summary>
    ...
    /// </summary>
    public string GITHUB_OUTPUT { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_OUTPUT)) ?? "";
    /// <summary>
    /// The path on the runner to the file that sets system PATH variables from workflow commands. The path to this file is unique to the current step and changes for each step in a job. For example, /home/runner/work/_temp/_runner_file_commands/add_path_899b9445-ad4a-400c-aa89-249f18632cf5. For more information, see Workflow commands for GitHub Actions.
    /// </summary>
    public string GITHUB_PATH { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_PATH)) ?? "";
    /// <summary>
    ...
    /// </summary>
    public string GITHUB_REF { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_REF)) ?? "";
    /// <summary>
    ...
    /// </summary>
    public string GITHUB_REF_NAME { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_REF_NAME)) ?? "";
    /// <summary>
    /// The type of ref that triggered the workflow run. Valid values are branch or tag.
    /// </summary>
    public string GITHUB_REF_TYPE { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_REF_TYPE)) ?? "";
    /// <summary>
    /// The owner and repository name. For example, octocat/Hello-World.
    /// </summary>
    public string GITHUB_REPOSITORY { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_REPOSITORY)) ?? throw new ArgumentNullException("Environment Variable 'GITHUB_REPOSITORY' is missing.");
    /// <summary>
    /// The repository owner's name. For example, octocat.
    /// </summary>
    public string GITHUB_REPOSITORY_OWNER { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_REPOSITORY_OWNER)) ?? "";
    /// <summary>
    ...
    /// </summary>
    public int GITHUB_RUN_ATTEMPT { get; init; } = int.Parse(Environment.GetEnvironmentVariable(nameof(GITHUB_RUN_ATTEMPT)) ?? "1");
    /// <summary>
    /// A unique number for each workflow run within a repository. This number does not change if you re-run the workflow run. For example, 1658821493.
    /// </summary>
    public string GITHUB_RUN_ID { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_RUN_ID)) ?? throw new ArgumentNullException("Environment Variable 'GITHUB_RUN_ID' is missing.");
    /// <summary>
    ...
    /// </summary>
    public string GITHUB_RUN_NUMBER { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_RUN_NUMBER)) ?? "";
    /// <summary>
    /// The URL of the GitHub server. For example: https://github.com.
    /// </summary>
    public string GITHUB_SERVER_URL { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_SERVER_URL)) ?? throw new ArgumentNullException("Environment Variable 'GITHUB_SERVER_URL' is missing.");
    /// <summary>
    ...
    /// </summary>
    public string GITHUB_SHA { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_SHA)) ?? "";
    /// <summary>
    ...
    /// </summary>
    public string GITHUB_TRIGGERING_ACTOR { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_TRIGGERING_ACTOR)) ?? "";
    /// <summary>
    ...
    /// </summary>
    public string GITHUB_WORKFLOW { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_WORKFLOW)) ?? "";
    /// <summary>
    /// The ref path to the workflow. For example, octocat/hello-world/.github/workflows/my-workflow.yml@refs/heads/my_branch.
    /// </summary>
    public string GITHUB_WORKFLOW_REF { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_WORKFLOW_REF)) ?? "";
    /// <summary>
    ...
    /// </summary>
    public string GITHUB_WORKSPACE { get; init; } = Environment.GetEnvironmentVariable(nameof(GITHUB_WORKSPACE)) ?? "";
    /// <summary>
    /// The head ref or source branch of the pull request in a workflow run. This property is only set when the event that triggers a workflow run is either pull_request or pull_request_target. For example, feature-branch-1.
    /// </summary>
    public string HEAD_REF { get; init; } = Environment.GetEnvironmentVariable(nameof(HEAD_REF)) ?? "";
    /// <summary>
    /// The architecture of the runner executing the job. Possible values are X86, X64, ARM, or ARM64.
    /// </summary>
    public string RUNNER_ARCH { get; init; } = Environment.GetEnvironmentVariable(nameof(RUNNER_ARCH)) ?? "";
    /// <summary>
    ...
    /// </summary>
    public bool RUNNER_DEBUG { get; init; } = int.Parse(Environment.GetEnvironmentVariable(nameof(RUNNER_DEBUG)) ?? "0") == 1;
    /// <summary>
    /// The operating system of the runner executing the job. Possible values are Linux, Windows, or macOS. For example, Windows
    /// </summary>
    public string RUNNER_OS { get; init; } = Environment.GetEnvironmentVariable(nameof(RUNNER_OS)) ?? "";
    ...
    /// </summary>
    public string PATH { get; init; } = Environment.GetEnvironmentVariable(nameof(PATH)) ?? "";
    /// <summary>
    /// Environment Variables to the PATH
    /// </summary>
    public bool ACTIONS_STEP_DEBUG { get; init; } = bool.Parse(Environment.GetEnvironmentVariable(nameof(ACTIONS_STEP_DEBUG)) ?? "false");
}
